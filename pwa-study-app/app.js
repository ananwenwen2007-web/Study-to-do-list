...
const TEXTBOOK_DATA = {
  english: {
    'yl-7a': {
      ...
      units: {
        'U1': {
          ...
          words: [
            { word: 'master', phonetic: '/ˈmɑːstə(r)/', meaning: '主人；大师', tip: 'mast(桅杆)+er→像桅杆一样高大的人→大师' },
            { word: 'grade', phonetic: '/ɡreɪd/', meaning: '年级', tip: 'grad(步)+e→一步一步升级→年级' },
            { word: 'student', phonetic: '/stjuːdnt/', meaning: '学生', tip: 'stu(看)+dent(牙齿)→露出牙齿看的人→学生' },
            { word: 'reading', phonetic: '/ˈriːdɪŋ/', meaning: '阅读', tip: 'read(读)+ing→正在读→阅读' },
            { word: 'classmate', phonetic: '/ˈklɑːsmeɪt/', meaning: '同班同学', tip: 'class(班级)+mate(伙伴)→班级里的伙伴→同班同学' },
            { word: 'after', phonetic: '/ˈɑːftə(r)/', meaning: '在……之后', tip: 'af(加强)+ter(后)→在后面→之后' },
            { word: 'slim', phonetic: '/slɪm/', meaning: '苗条的', tip: 's(像曲线)+lim(限制)→限制成曲线→苗条的' },
            { word: 'over', phonetic: '/ˈəʊvə(r)/', meaning: '超过；在……上方', tip: 'o(圆)+ver(覆盖)→覆盖在上面→上方' },
            { word: 'walking', phonetic: '/ˈwɔkɪŋ/', meaning: '步行', tip: 'walk(走)+ing→正在走→步行' },
            { word: 'really', phonetic: '/riːəli/', meaning: '的确；确实', tip: 'real(真实的)+ly→真实地→的确' },
            { word: 'polite', phonetic: '/pəˈlaɪt/', meaning: '有礼貌的', tip: 'po(加强)+lite(轻)→举止轻盈得体→有礼貌的' },
            { word: 'clever', phonetic: '/ˈklevə(r)/', meaning: '聪明的', tip: 'c(看)+lever(杠杆)→能找到杠杆的人→聪明的' },
            { word: 'careful', phonetic: '/ˈkeəfl/', meaning: '仔细的', tip: 'care(关心)+ful(充满)→充满关心的→仔细的' },
            { word: 'helpful', phonetic: '/ˈhelpfl/', meaning: '乐于助人的', tip: 'help(帮助)+ful(充满)→充满帮助的→乐于助人的' },
            { word: 'hobby', phonetic: '/ˈhɒbi/', meaning: '爱好', tip: 'hob(小马)+by→骑小马是爱好→爱好' },
            { word: 'glad', phonetic: '/ɡlæd/', meaning: '高兴的', tip: 'g(看)+lad(小伙子)→看到小伙子很高兴→高兴的' },
            { word: 'everyone', phonetic: '/evriwʌn/', meaning: '每个人', tip: 'every(每个)+one(一)→每一个人→每个人' },
            { word: 'born', phonetic: '/bɔːn/', meaning: '出生', tip: 'bor(承载)+n→被承载出来→出生' },
            { word: 'cute', phonetic: '/kjuːt/', meaning: '可爱的', tip: 'c(看)+ute(出来)→让人看出来的可爱→可爱的' },
            { word: 'friendly', phonetic: '/ˈfrendli/', meaning: '友好的', tip: 'friend(朋友)+ly→像朋友一样→友好的' },
            { word: 'shy', phonetic: '/ʃaɪ/', meaning: '害羞的', tip: 'sh(嘘)+y→嘘声让人害羞→害羞的' },
            { word: 'glasses', phonetic: '/ˈɡlɑːsɪz/', meaning: '眼镜', tip: 'glass(玻璃)+es→玻璃做的→眼镜' },
            { word: 'dancing', phonetic: '/ˈdɑːnsɪ/', meaning: '跳舞', tip: 'dance(跳舞)+ing→正在跳舞→跳舞' },
            { word: 'singing', phonetic: '/ˈsɪŋŋ/', meaning: '唱歌', tip: 'sing(唱)+ing→正在唱→唱歌' },
            { word: 'drawing', phonetic: '/ˈdrɔːɪŋ/', meaning: '画画', tip: 'draw(画)+ing→正在画→画画' },
          ]
        },
        'U2': {
          title: 'Unit 2 Let\'s play sports!',
          words: [
            { word: 'sports', phonetic: '/spɔːts/', meaning: '运动', tip: 'sport(运动)+s→多种运动→运动' },
            { word: 'really', phonetic: '/riːəli/', meaning: '的确；确实', tip: 'real(真实的)+ly→真实地→的确' },
            { word: 'bowl', phonetic: '/bəʊl/', meaning: '碗', tip: 'bow(弯曲)+l→弯曲的容器→碗' },
            { word: 'time', phonetic: '/taɪm/', meaning: '次；回', tip: 't(特)+ime(时间)→特定时间→次/回' },
            { word: 'tennis', phonetic: '/ˈtenɪs/', meaning: '网球', tip: 'ten(十)+nis→十次击球→网球' },
            { word: 'volleyball', phonetic: '/ˈvɒlibɔːl/', meaning: '排球', tip: 'volley(截击)+ball(球)→截击球→排球' },
            { word: 'enjoy', phonetic: '/ɪnˈdʒɔɪ/', meaning: '享受……的乐趣', tip: 'en(使)+joy(快乐)→使快乐→享受' },
            { word: 'club', phonetic: '/klʌb/', meaning: '俱乐部', tip: 'c(聚集)+lub→聚集的地方→俱乐部' },
            { word: 'free', phonetic: '/friː/', meaning: '空闲的', tip: 'f(自由)+ree→自由的→空闲的' },
            { word: 'dream', phonetic: '/driːm/', meaning: '梦想', tip: 'dr(拖)+eam→拖出来的想法→梦想' },
            { word: 'hero', phonetic: '/ˈhɪərəʊ/', meaning: '英雄', tip: 'her(她)+o→她心中的英雄→英雄' },
            { word: 'match', phonetic: '/mætʃ/', meaning: '比赛', tip: 'mat(垫子)+ch→在垫子上比→比赛' },
            { word: 'player', phonetic: '/ˈpleɪə(r)/', meaning: '运动员', tip: 'play(玩)+er→玩的人→运动员' },
            { word: 'music', phonetic: '/mjuːzɪk/', meaning: '音乐', tip: 'mu(缪斯)+sic→缪斯女神的艺术→音乐' },
            { word: 'paper', phonetic: '/ˈpeɪpə(r)/', meaning: '论文；报纸', tip: 'pap(纸)+er→纸做的→报纸' },
            { word: 'design', phonetic: '/dɪˈzaɪn/', meaning: '设计', tip: 'de(加强)+sign(标记)→加强标记→设计' },
            { word: 'member', phonetic: '/ˈmembə(r)/', meaning: '成员', tip: 'mem(记忆)+ber→记住的人→成员' },
            { word: 'start', phonetic: '/stɑːt/', meaning: '开始', tip: 'st(站)+art→站起来开始→开始' },
            { word: 'hope', phonetic: '/həʊp/', meaning: '希望', tip: 'h(高)+ope→高处的期望→希望' },
            { word: 'come', phonetic: '/kʌm/', meaning: '来', tip: 'c(看)+ome→看过来→来' },
            { word: 'true', phonetic: '/truː/', meaning: '真实的', tip: 't(特)+rue→特别真的→真实的' },
            { word: 'fun', phonetic: '/fʌn/', meaning: '乐趣', tip: 'f(飞)+un→飞起来的快乐→乐趣' },
            { word: 'world', phonetic: '/wɜːld/', meaning: '世界', tip: 'wor(人)+ld→人住的地方→世界' },
            { word: 'favourite', phonetic: '/ˈfeɪvərɪt/', meaning: '最喜欢的', tip: 'favor(喜爱)+ite→喜爱的→最喜欢的' },
            { word: 'write', phonetic: '/raɪt/', meaning: '写', tip: 'w(看)+rite→看下来写→写' },
          ]
        },
        'U3': {
          title: 'Unit 3 Welcome to our school!',
          words: [
            { word: 'which', phonetic: '/wɪtʃ/', meaning: '哪一个', tip: 'wh(问)+ich→问哪个→哪一个' },
            { word: 'building', phonetic: '/ˈbɪldɪŋ/', meaning: '建筑物', tip: 'build(建造)+ing→建造的东西→建筑物' },
            { word: 'field', phonetic: '/fiːld/', meaning: '场地', tip: 'fie(感觉)+ld→感觉到的地方→场地' },
            { word: 'library', phonetic: '/ˈlaɪbrəri/', meaning: '图书馆', tip: 'liber(书)+ary→放书的地方→图书馆' },
            { word: 'only', phonetic: '/ˈəʊnli/', meaning: '只；只有', tip: 'on(一)+ly→只有一个→只' },
            { word: 'gate', phonetic: '/ɡeɪt/', meaning: '大门', tip: 'g(看)+ate→看门的地方→大门' },
            { word: 'bright', phonetic: '/braɪt/', meaning: '明亮的', tip: 'b(光)+right→光对了→明亮的' },
            { word: 'modern', phonetic: '/ˈmɒdn/', meaning: '现代的', tip: 'mod(模式)+ern→新模式→现代的' },
            { word: 'hall', phonetic: '/hːl/', meaning: '大厅', tip: 'h(高)+all→高大的空间→大厅' },
            { word: 'diary', phonetic: '/ˈdaɪəri/', meaning: '日记', tip: 'di(日)+ary→每日记录→日记' },
            { word: 'art', phonetic: '/ɑːt/', meaning: '艺术', tip: 'ar(艺术)+t→艺术→艺术' },
            { word: 'lesson', phonetic: '/ˈlesn/', meaning: '课', tip: 'less(少)+on→少量的知识→课' },
            { word: 'begin', phonetic: '/bɪˈɡɪn/', meaning: '开始', tip: 'be(是)+gin→是起点→开始' },
            { word: 'welcome', phonetic: '/ˈwelkəm/', meaning: '欢迎', tip: 'well(好)+come→好的来了→欢迎' },
            { word: 'show', phonetic: '/ʃə/', meaning: '展示', tip: 'sh(看)+ow→看过来→展示' },
            { word: 'around', phonetic: '/əˈraʊnd/', meaning: '在……周围', tip: 'a(一)+round→一圈→周围' },
            { word: 'let', phonetic: '/let/', meaning: '让', tip: 'l(看)+et→看它→让' },
            { word: 'us', phonetic: '/ʌs/', meaning: '我们', tip: 'u(你)+s→你和我→我们' },
            { word: 'look', phonetic: '/lʊk/', meaning: '看', tip: 'l(眼)+ook→用眼看→看' },
            { word: 'at', phonetic: '/æt/', meaning: '在', tip: 'a(一)+t→在一个点→在' },
            { word: 'our', phonetic: '/aʊə(r)/', meaning: '我们的', tip: 'o(一)+ur→我们的→我们的' },
            { word: 'school', phonetic: '/skuːl/', meaning: '学校', tip: 'sch(学)+ool→学习的地方→学校' },
            { word: 'classroom', phonetic: '/ˈklɑːsruːm/', meaning: '教室', tip: 'class(班级)+room→班级的房间→教室' },
            { word: 'playground', phonetic: '/ˈpleɪɡraʊnd/', meaning: '操场', tip: 'play(玩)+ground→玩的地方→操场' },
            { word: 'office', phonetic: '/ˈɒfɪs/', meaning: '办公室', tip: 'of(离开)+fice→离开教室的地方→办公室' },
          ]
        },
        'U4': {
          title: 'Unit 4 My day',
          words: [
            { word: 'wake', phonetic: '/weɪk/', meaning: '醒；唤醒', tip: 'w(看)+ake→看到就醒→醒' },
            { word: 'morning', phonetic: '/ˈmɔːnɪ/', meaning: '早晨', tip: 'morn(早晨)+ing→早晨→早晨' },
            { word: 'hill', phonetic: '/hɪl/', meaning: '小山', tip: 'h(高)+ill→高的地方→小山' },
            { word: 'seldom', phonetic: '/ˈseldəm/', meaning: '很少', tip: 'sel(选择)+dom→选择少→很少' },
            { word: 'out', phonetic: '/aʊt/', meaning: '出来', tip: 'o(外)+ut→向外→出来' },
            { word: 'need', phonetic: '/niːd/', meaning: '需要', tip: 'n(不)+eed→不有不行→需要' },
            { word: 'rest', phonetic: '/rest/', meaning: '休息', tip: 're(再)+st→再停下来→休息' },
            { word: 'once', phonetic: '/wʌns/', meaning: '一次', tip: 'on(一)+ce→一→一次' },
            { word: 'activity', phonetic: '/ækˈtɪvəti/', meaning: '活动', tip: 'act(行动)+ivity→行动的事→活动' },
            { word: 'homework', phonetic: '/ˈhəʊmwɜːk/', meaning: '家庭作业', tip: 'home(家)+work→家里做的工→作业' },
            { word: 'lunch', phonetic: '/lʌntʃ/', meaning: '午餐', tip: 'lun(中午)+ch→中午吃的→午餐' },
            { word: 'dinner', phonetic: '/ˈdɪnə(r)/', meaning: '晚餐', tip: 'din(晚)+ner→晚上吃的→晚餐' },
            { word: 'breakfast', phonetic: '/ˈbrekfəst/', meaning: '早餐', tip: 'break(打破)+fast→打破禁食→早餐' },
            { word: 'usually', phonetic: '/ˈjuːʒuəli/', meaning: '通常', tip: 'usual(通常)+ly→通常→通常' },
            { word: 'never', phonetic: '/ˈnevə(r)/', meaning: '从不', tip: 'n(不)+ever→不曾经→从不' },
            { word: 'always', phonetic: '/ˈɔːlwez/', meaning: '总是', tip: 'all(全部)+ways→所有方式→总是' },
            { word: 'sometimes', phonetic: '/ˈsʌmtaɪmz/', meaning: '有时', tip: 'some(一些)+times→一些时候→有时' },
            { word: 'often', phonetic: '/ˈɒfn/', meaning: '经常', tip: 'of(离开)+ten→离开十次→经常' },
            { word: 'every', phonetic: '/ˈevri/', meaning: '每个', tip: 'ev(一)+ery→每一→每个' },
            { word: 'day', phonetic: '/deɪ/', meaning: '天', tip: 'd(日)+ay→日→天' },
            { word: 'week', phonetic: '/wiːk/', meaning: '周', tip: 'w(看)+eek→看一圈→周' },
            { word: 'month', phonetic: '/mʌnθ/', meaning: '月', tip: 'mon(月)+th→月→月' },
            { word: 'year', phonetic: '/jɪə(r)/', meaning: '年', tip: 'y(一)+ear→一轮回→年' },
            { word: 'today', phonetic: '/təˈdeɪ/', meaning: '今天', tip: 'to(到)+day→到这一天→今天' },
            { word: 'tomorrow', phonetic: '/təˈmɒrəʊ/', meaning: '明天', tip: 'to(到)+morrow→到下一天→明天' },
          ]
        },
      }
    },
    'yl-7b': {
      ...
      units: {
        'U1': {
          title: 'Unit 1 Dream homes',
          words: [
            { word: 'next', phonetic: '/nekst/', meaning: '下一个', tip: 'n(新)+ext→新的延伸→下一个' },
            { word: 'town', phonetic: '/taʊn/', meaning: '城镇', tip: 't(土)+own→自己的土地→城镇' },
            { word: 'capital', phonetic: '/ˈkæpɪtl/', meaning: '首都', tip: 'cap(头)+ital→头的地方→首都' },
            { word: 'balcony', phonetic: '/bælkəni/', meaning: '阳台', tip: 'bal(栏)+cony→栏杆围的→阳台' },
            { word: 'share', phonetic: '/ʃeə(r)/', meaning: '分享', tip: 'sh(手)+are→手给出去→分享' },
            { word: 'bedroom', phonetic: '/ˈbedruːm/', meaning: '卧室', tip: 'bed(床)+room→放床的房间→卧室' },
            { word: 'own', phonetic: '/ən/', meaning: '自己的', tip: 'o(一)+wn→唯一属于→自己的' },
            { word: 'bathroom', phonetic: '/ˈbɑːθruːm/', meaning: '浴室', tip: 'bath(洗澡)+room→洗澡的房间→浴室' },
            { word: 'kitchen', phonetic: '/kɪtʃɪn/', meaning: '厨房', tip: 'kit(工具)+chen→用工具的地方→厨房' },
            { word: 'garden', phonetic: '/ˈɡɑːdn/', meaning: '花园', tip: 'gar(围)+den→围起来的地方→花园' },
            { word: 'floor', phonetic: '/flɔː(r)/', meaning: '楼层', tip: 'fl(平)+oor→平的面→楼层' },
            { word: 'hundred', phonetic: '/hʌndrəd/', meaning: '百', tip: 'hun(百)+dred→百→百' },
            { word: 'thousand', phonetic: '/ˈθaʊznd/', meaning: '千', tip: 'thou(千)+sand→千→千' },
            { word: 'million', phonetic: '/ˈmɪljən/', meaning: '百万', tip: 'mil(千)+lion→千个千→百万' },
            { word: 'metre', phonetic: '/ˈmiːtə(r)/', meaning: '米', tip: 'met(测量)+re→测量的单位→米' },
            { word: 'area', phonetic: '/eəriə/', meaning: '面积', tip: 'ar(区域)+ea→区域→面积' },
            { word: 'square', phonetic: '/skweə(r)/', meaning: '平方', tip: 'squ(方)+are→方形→平方' },
            { word: 'foot', phonetic: '/fʊt/', meaning: '英尺', tip: 'f(脚)+oot→脚的长度→英尺' },
            { word: 'inch', phonetic: '/ɪntʃ/', meaning: '英寸', tip: 'in(一)+ch→一寸→英寸' },
            { word: 'size', phonetic: '/saɪz/', meaning: '尺寸', tip: 's(看)+ize→看到的大小→尺寸' },
            { word: 'large', phonetic: '/lɑːdʒ/', meaning: '大的', tip: 'l(大)+arge→大→大的' },
            { word: 'small', phonetic: '/smɔːl/', meaning: '小的', tip: 's(少)+mall→少→小的' },
            { word: 'big', phonetic: '/bɪɡ/', meaning: '大的', tip: 'b(大)+ig→大→大的' },
            { word: 'beautiful', phonetic: '/ˈbjuːtɪfl/', meaning: '美丽的', tip: 'beaut(美)+iful→美的→美丽的' },
            { word: 'comfortable', phonetic: '/ˈkʌmftəbl/', meaning: '舒适的', tip: 'com(共)+fort(力量)→共同有力→舒适的' },
          ]
        },
        'U2': {
          title: 'Unit 2 Neighbours',
          words: [
            { word: 'neighbour', phonetic: '/ˈneɪbə(r)/', meaning: '邻居', tip: 'neigh(近)+bour→近的人→邻居' },
            { word: 'help', phonetic: '/help/', meaning: '帮助', tip: 'h(手)+elp→手伸出来→帮助' },
            { word: 'problem', phonetic: '/ˈprɒbləm/', meaning: '问题', tip: 'pro(前)+blem→前面的障碍→问题' },
            { word: 'something', phonetic: '/ˈsʌmθɪ/', meaning: '某事', tip: 'some(一些)+thing→一些事→某事' },
            { word: 'engineer', phonetic: '/ˌendʒɪˈnɪə(r)/', meaning: '工程师', tip: 'engin(引擎)+eer→做引擎的人→工程师' },
            { word: 'check', phonetic: '/tʃek/', meaning: '检查', tip: 'ch(看)+eck→看一遍→检查' },
            { word: 'lucky', phonetic: '/ˈlki/', meaning: '幸运的', tip: 'luck(运气)+y→有运气的→幸运的' },
            { word: 'college', phonetic: '/ˈkɒlɪdʒ/', meaning: '大学', tip: 'col(共同)+lege→共同学习→大学' },
            { word: 'company', phonetic: '/ˈkmpəni/', meaning: '公司', tip: 'com(共)+pany→共同做事→公司' },
            { word: 'manager', phonetic: '/ˈmænɪdə(r)/', meaning: '经理', tip: 'man(人)+ager→管人的人→经理' },
            { word: 'office', phonetic: '/ˈɒfɪs/', meaning: '办公室', tip: 'of(离开)+fice→离开教室→办公室' },
            { word: 'post', phonetic: '/pəʊst/', meaning: '邮政', tip: 'p(送)+ost→送出去→邮政' },
            { word: 'station', phonetic: '/steɪʃn/', meaning: '站', tip: 'stat(站)+ion→站的地方→站' },
            { word: 'police', phonetic: '/pəˈliːs/', meaning: '警察', tip: 'pol(城市)+ice→城市守卫→警察' },
            { word: 'fire', phonetic: '/faɪə(r)/', meaning: '火', tip: 'f(火焰)+ire→火焰→火' },
            { word: 'doctor', phonetic: '/ˈdɒktə(r)/', meaning: '医生', tip: 'doc(教)+tor→教健康的人→医生' },
            { word: 'nurse', phonetic: '/nɜːs/', meaning: '护士', tip: 'n(护理)+urse→护理的人→护士' },
            { word: 'cook', phonetic: '/kʊk/', meaning: '厨师', tip: 'c(烹饪)+ook→烹饪的人→厨师' },
            { word: 'driver', phonetic: '/ˈdraɪvə(r)/', meaning: '司机', tip: 'drive(驾驶)+er→驾驶的人→司机' },
            { word: 'farmer', phonetic: '/ˈfɑːmə(r)/', meaning: '农民', tip: 'farm(农场)+er→农场的人→农民' },
            { word: 'teacher', phonetic: '/ˈtiːtʃə(r)/', meaning: '老师', tip: 'teach(教)+er→教的人→老师' },
            { word: 'student', phonetic: '/stjuːdnt/', meaning: '学生', tip: 'stu(学)+dent→学的人→学生' },
            { word: 'worker', phonetic: '/ˈwɜːkə(r)/', meaning: '工人', tip: 'work(工作)+er→工作的人→工人' },
            { word: 'artist', phonetic: '/ˈɑːtɪst/', meaning: '艺术家', tip: 'art(艺术)+ist→搞艺术的人→艺术家' },
            { word: 'singer', phonetic: '/ˈsɪŋə(r)/', meaning: '歌手', tip: 'sing(唱)+er→唱的人→歌手' },
          ]
        },
      }
    }
